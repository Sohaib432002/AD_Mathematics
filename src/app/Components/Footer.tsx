            ...
            <section className=' bg-[#2a2a2b] '>
                ...
                <div className="nav-list">
                    <ul className='flex justify-center items-center gap-30 max-[950px]:gap-10 max-[580px]:gap-4  text-gray'>
                        <li className='list-none ' ><a className='no-underline font-medium text-[20px] max-[580]:text-[15px] hover:text-[#E46400] transition  duration-200' href="£">Home</a></li>
                        <li className='list-none ' ><a className='no-underline font-medium text-[20px] max-[580]:text-[15px] hover:text-[#E46400] transition  duration-200' href="£">Service</a></li>
                        ...
                        <li className='list-none' ><a className='no-underline font-medium text-[20px] max-[580]:text-[15px] hover:text-[#E46400] transition  duration-200' href="£">Portfolio</a></li>
                        <li className='list-none' ><a className='no-underline font-medium text-[20px] max-[580]:text-[15px] hover:text-[#E46400] transition  duration-200' href="£">Contact Me</a></li>
                    </ul>
                </div>
                ...
                <div className='flex justify-center items-center b-t-2 mt-5 '>
                    <p className='text-center text-[#959595] font-bold'>© 2023 Mahmood Fazile. All rights reserved.</p>
                </div>
            </section>
        </>
    )

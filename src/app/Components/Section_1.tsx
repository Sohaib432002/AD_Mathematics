...
function Section_1() {
    ...
    return (
        <>
            <section className='font-loto m-7 flex justify-between max-[1000px]:flex-wrap' >
                <div className=' w-[50%] max-[1000px]:w-[100%] max-[1000px]:text-center flex justify-center flex-col' style={{ backgroundImage: "url('./Vector.png')", backgroundSize: 'cover', backgroundPosition: 'center' }}>
                    ...
                    <div>
                        ...
                        <div className="btn-section0">
                            <button className="bg-[linear-gradient(90deg,_#FD6F00_0%,_#E46400_100%)] mr-10 text-[20px] text-white px-10 py-3 rounded cursor-pointer max-[550px]:text-[15px] max-[400px]:m-23">
                                Hire Me
                            </button>

                            <button className='bg-[transparent] border px-10 py-3 hover:bg-white transition  duration-200  rounded text-[#959595] font-bold rounded-lg text-[20px] max-[550px]:text-[15px] cursor-pointer ' >Download Cv</button>
                        </div>
                    </div>
                    <div className='flex justify-start max-[1000px]:justify-center py-4'>
                    <div className='flex my-10 items-center bg-[#1e2125] max-[850px]:w-[100%] max-[850px]:justify-center rounded p-4'>

                        <div className='flex justify-between flex-col max-[550px]:text-[17px] max-[550px]:text-left border-[#575757] font-extrabold border-r text-[20px]'>
                            <h3 className='py-3 text-[#FD6F00]'>5+</h3>
                            <h3 className='pr-5'>Experiences</h3>
                        </div>
                        <div className='flex justify-between max-[550px]:text-[15px] max-[550px]:text-left  border-[#575757] flex-col font-extrabold border-r text-[20px]'>
                            <h3 className='p-3 text-[#FD6F00]'>20+</h3>
                            <h3 className='px-5'>Project done</h3>
                        </div>
                        <div className='flex justify-between max-[550px]:text-[15px] max-[550px]:text-left  flex-col font-extrabold  text-[20px]'>

...
function Section_1() {
    ...
    return (
        <>
            <section className='font-loto m-7 flex justify-between max-[500px]:mx-0 max-[1000px]:flex-wrap' >
                <div className=' w-[50%] max-[1000px]:w-[100%] max-[1000px]:text-center  flex justify-center flex-col' style={{ backgroundImage: "url('./Vector.png')", backgroundSize: 'cover', backgroundPosition: 'center' }}>
                    ...
                    <div>
                        ...
                        <div className="btn-section0">
                            <button className="bg-[linear-gradient(90deg,_#FD6F00_0%,_#E46400_100%)] mr-10 text-[20px] text-white px-10 py-3 rounded cursor-pointer max-[550px]:text-[15px] max-[400px]:m-3">
                                Hire Me
                            </button>

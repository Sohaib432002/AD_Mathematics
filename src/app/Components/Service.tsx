...
function Section2() {
    return (
        <>
            <section id='Service' className='font-loto m-7  max-[500px]:mx-0  max-[1000px]:flex-wrap' >
                ...
                <div className='grid px-70 max-[1500px]:px-3 grid-cols-3 max-[400px]:grid-cols-1 max-[550px]:g-0 gap-5 max-[1000px]:grid-cols-2 max-[1000px]:gap-3 mt-10'>
                    <div className='flex  flex-col items-center justify-center text-center p-5 m-3 border border-[#707070] rounded-lg hover:bg-[#FD6F00] hover:text-white transition duration-200 cursor-pointe'>
                        <img src="./Visul.png" alt="Combined-Shape" className=' max-[550px]:max-w-[34px]    max-w-[58px]' />
                        <h4 className='text-[24px] max-[550px]:text-[20px] my-3 font-bold'>Data Analysis & Visualization</h4>
                    ...
                    <div className='flex flex-col items-center justify-center text-center p-5 m-3 border border-[#707070] rounded-lg hover:bg-[#FD6F00] hover:text-white transition duration-200 cursor-pointe'>
                        <img src="./Ml.png" alt="Combined-Shape" className=' max-[550px]:max-w-[34px]    max-w-[58px]' />
                        <h4 className='text-[24px] max-[550px]:text-[20px] my-3 font-bold'>Machine Learning Solutions</h4>
                    ...
                    <div className='flex flex-col items-center justify-center text-center p-5 m-3 border border-[#707070] rounded-lg hover:bg-[#FD6F00] hover:text-white transition duration-200 cursor-pointe'>
                        <img src="./Research.png" alt="Combined-Shape" className=' max-[550px]:max-w-[34px]    max-w-[58px]' />
                        <h4 className='text-[24px] max-[550px]:text-[20px] my-3 font-bold'>Research & Simulation Support</h4>
                    ...
                    <div className='flex flex-col items-center justify-center text-center p-5 m-3 border border-[#707070] rounded-lg hover:bg-[#FD6F00] hover:text-white transition duration-200 cursor-pointe'>
                        <img src="./Assig.png" alt="Combined-Shape" className=' max-[550px]:max-w-[34px]    max-w-[58px]' />
                        <h4 className='text-[24px] max-[550px]:text-[20px] my-3 font-bold'> Academic Tutoring & Assignment Help</h4>
                    ...
                    <div className='flex flex-col items-center justify-center text-center p-5 m-3  border border-[#707070] rounded-lg hover:bg-[#FD6F00] hover:text-white transition duration-200 cursor-pointe'>
                        <img src="./pic.png" alt="Combined-Shape" className=' max-[550px]:max-w-[34px]    max-w-[58px]' />
                        <h4 className='text-[24px] max-[550px]:text-[20px] my-3 font-bold'>Event & Media Management</h4>
